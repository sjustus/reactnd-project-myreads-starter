...
class BookshelfChanger extends React.Component {
  render() {
    return (
       ...
       * For help with passing setting value, event.target.value as param/applying above concept [Tutorial Requests: FEND Project 6 - Walk Through (LONG)](https://www.youtube.com/watch?v=acJHkd6K5kI&=&feature=youtu.be)
      */
